...
def insert_dishes(cur):
    ...
    cur.execute("""
        ...
        VALUES  ('Харчо', 260.00, 1),
                ...
                ('Горбушка в духовке', 550.00, 3),
                ('Свинина по Фраецузски', 600.00, 3),
                ('Креветки запеченные с сыром', 650.00, 3),
                ('Стейк', 900.00, 3),
                ('Панна котта', 250.00, 4),
                ('Марципан', 270.00, 4),
                ('Тирамису', 350.00, 4),
                ('Мороженое', 180.00, 4),
                ('Чизкейк', 320.00, 4),
...
def get_cheapest_dishes(conn):
    ...
    try:
        ...
        if N <= 0:
            print("Ошибка: количество блюд должно быть положительным числом")
            return
...
def main():
    ...
    try:
        ...
        conn = psycopg2.connect(
            ...
            # Тут важно, вспомнить пароль указаный при установке Postgresql
            user="postgres",
            password="12345678",
            host="localhost",
            port="5432"
